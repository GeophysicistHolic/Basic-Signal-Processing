...
cross_chirp = np.cos(2*np.pi*(10+(t/7))*(t/lt)) + np.cos(2*np.pi*((lt/2.8)-(t/6.0))*(t/lt))
...
axs[0,0].plot(t,cross_chirp)
axs[0, 0].set_title('Original Signal Cross Chirp')
